...
import cafeBackgroundImage from "../assets/images/modern-cafe-house.webp";
import yarnisarImage from "../assets/images/yarnisar.png";
    ...
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <img src={yarnisarImage} alt="Yarnisar" className="h-full w-full object-cover" />
          </div>
        </div>
